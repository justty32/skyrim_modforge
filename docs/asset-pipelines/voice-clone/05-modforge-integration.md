...
### Sources
Internal conventions read from `docs/CODE_MAP.infra.md`, `src/ModForge.Core/Papyrus.cs`, `src/ModForge.Core/Spec.Actors.cs`, `src/ModForge.Cli/ModForge.Cli.csproj`. Engine/format facts: see [01]–[04].
