...
| [items-magic.md](items-magic.md) | GLOB / MESG menu / PROJ+EXPL / EFSH / MGEF 擴充 / FormList / Hazard / Music | [CODE_MAP.items-magic](../../common/code-map/CODE_MAP.items-magic.md) |
