...
- **隨從擴充**：[`sub_projs/sofia-patch/`](../../../sub_projs/sofia-patch/README.md)（**獨立消費者專案**，拿 ModForge 當工具；`README.md` 為索引）— `follower-decode-2026-06-13.md`（結構+內容索引）、`expansion-plan-2026-06-13.md`（11✅/3🟡/2🔴）、`sofia-personality.md`（性格分析/寫作 brief）
...
- **語音調查**：[`notes-gemini-voice-2026-06-10.md`](notes-gemini-voice-2026-06-10.md)、[`sleeping-giant-inn-reverse-2026-06-13.md`](sleeping-giant-inn-reverse-2026-06-13.md)（`cellrefs` 逆向 vanilla interior cell → `placements[]`）
