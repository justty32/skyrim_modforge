...
- **隨從擴充**：[`../sofia-patch/`](../../../sub_projs/sofia-patch/README.md)（**獨立消費者專案**，拿 ModForge 當工具；`README.md` 為索引）— `reference/follower-decode-2026-06-13.md`（結構+內容索引）、`plans/expansion-plan-2026-06-13.md`（11✅/3🟡/2🔴）、`reference/sofia-personality.md`（性格分析/寫作 brief）
