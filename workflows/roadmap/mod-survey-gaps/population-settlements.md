...
調查 8 個人口類 mod（[Populated 全家桶](../../../../../analysis/mod-survey/findings/systems-population/populated-skyrim-family.md)＋[prison-cells](../../../../../analysis/mod-survey/findings/systems-population/populated-prison-cells.md)、[Immersive Citizens AIO](../../../../../analysis/mod-survey/findings/systems-population/immersive-citizens-ai-overhaul.md)、[Immersive Wenches](../../../../../analysis/mod-survey/findings/systems-population/immersive-wenches.md)、[Cutting Room Floor](../../../../../analysis/mod-survey/findings/systems-population/cutting-room-floor.md)、[settlement-npc-expansions](../../../../../analysis/mod-survey/findings/systems-population/settlement-npc-expansions.md)、[wench-derivatives](../../../../../analysis/mod-survey/findings/systems-population/wench-derivatives.md)、[JK's set-dressing](../../../../../analysis/mod-survey/findings/systems-population/jks-skyrim-setdressing.md)）。**一致結論：每個低階機制都已 landed**（NPC base、全 PACK 模板、LeveledNpc、ACHR placement、additive cell-override、Vendor faction、RELA、SM 觸發 scene、radiant quest、MCM——各 finding 附 `src/` symbol evidence）。缺口集中在**便利層 + 一個小 PACK 模板**：
...
> **延伸調查**：缺口 #2（alias indirection）、#3（navmesh-tester）以及 LVLN fill（partial）均由 IWE/EE encounter mod 調查交叉驗證，見 [../../analysis/mod-survey/findings/encounter-mods.md](../../../../../analysis/mod-survey/findings/systems-encounters/encounter-mods.md)。
