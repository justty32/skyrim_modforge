...
- **自訂技能樹生成（Custom Skills Framework / CSF）** — ⏸️ **暫緩（2026-06-22 決定暫時先不做）**。讓 ModForge 從 spec 生成一棵自訂技能樹（VIGILANT/GLENMORIL/Constellations 同款）。研究已完成：分析見 [mod-survey/custom-skills-framework.md](../../sub_projs/mod-survey/custom-skills-framework.md)，實作指南見 [mod-survey/custom-skill-tree-guide.md](../../sub_projs/mod-survey/custom-skill-tree-guide.md)。
