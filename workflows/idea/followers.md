...
**施工參考**：[`sub_projs/sofia-patch/`](../../sub_projs/sofia-patch/README.md)（獨立專案）→ [`follower-decode-2026-06-13.md`](../../sub_projs/sofia-patch/reference/follower-decode-2026-06-13.md) — 解碼 Sofia Follower（30 quest / 28 scene / 1135 INFO / 57 GLOB）拆出五個可複用 pattern（小 controller-quest 星座、每情境一個 comment-scene、GLOB 狀態機、quest-stage+marker、玩家裝備驅動對話）+ ModForge 對應施工表。結論：Sofia 全是 ModForge 已落地能力的規模化組合，直接夠用。
