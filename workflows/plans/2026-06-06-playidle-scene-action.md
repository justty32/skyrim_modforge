...
**設計來源:** `workflows/specs/2026-06-06-playidle-scene-action-design.md`
**下游:** 多重身份系統(`workflows/specs/2026-06-06-identity-system-design.md`)聖騎士宣誓演出。
...
把 (Index 基數、FragmentName↔函式名規則、取 actor 寫法) 三點補進 `workflows/specs/2026-06-06-playidle-scene-action-design.md`。Task 2/4 以此為準。
...
- Modify: `workflows/specs/2026-06-06-playidle-scene-action-design.md`(補 Task 0 spike 結論)
...
```bash
git add examples/scene-playidle.json docs/SPEC-dialogue-quests.md docs/CODE_MAP.dialogue-quests.md workflows/specs/2026-06-06-playidle-scene-action-design.md
