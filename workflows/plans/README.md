...
worldspace heightmap 後端與 scene export M0–M2 都已落地，原始逐步計畫已移
[archive/](archive/README.md)；仍需真人操作的驗收只維護在 [WAIT_USER](../../WAIT_USER.md)。
action-system asset/config 生成（OAR/BDI/PIE）7 個 task 全落地（2026-06-14，547 測試綠燈），計畫也已封存；落地記錄見 [feature-dev/landed/infra.md](../feature-dev/landed/infra.md)。
