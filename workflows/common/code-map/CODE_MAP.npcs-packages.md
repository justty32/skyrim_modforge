...
| Build P2 | `Generator.Build.Conditions.Wire.cs` `WirePackageConditions` | package condition 接線（`BuildCondition` 組裝在 `Generator.Build.Conditions.cs`，dispatch 在 `Generator.Build.Conditions.Functions.cs`）|
