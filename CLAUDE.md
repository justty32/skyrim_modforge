...
- 「**怎麼做**」的橫向通則在**元工作流 [DEV-GUIDE.md](DEV-GUIDE.md)**（結構整理原則 + 四級成長；鐵律：重構**行為不變**、**未經確認不 push/不開新工作**）；只在**碰原始碼**時適用的**程式碼慣例 + CODE_MAP 維護鏈**在 [common/conventions](workflows/common/conventions.md)。
