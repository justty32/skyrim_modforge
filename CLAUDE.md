...
**身份系統 Phase-2/C**:① Adventurer 預設身份自動授予 ✅、② `activeWhen` 情境條件 ✅（皆 in-game 確認 2026-06-07，見下「已落地」）；尚未做：③ 聲望/行為追蹤、④ controller 主身份+手動覆寫（會解掉 ② 的 held-but-inactive gap）、⑤ 身份對應互動（交易 UI/護衛任務）。
