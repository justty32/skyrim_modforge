...
internal static partial class Program
{
    private static int? DispatchCore(string[] args) => args[0] switch
    {
        ...
        "modlist" => ModlistSnapshotCmd(args[1..]),
    ...
    private const string CoreUsage =
        ...
        "  modlist snapshot <profileDir> <out.json>  snapshot MO2 profile lists\n" +
        "  modlist diff <a.json> <b.json> [--json]  compare snapshots (exit 0 equal, 1 changed, 2 error)\n" +
