...
public sealed class CellSpec { public string EditorId { get; set; } = ""; public string Name { get; set; } = ""; public string Template { get; set; } = ""; public float? WaterHeight { get; set; } public string? Water { get; set; } public string? AcousticSpace { get; set; } public string EncounterZone { get; set; } = ""; public string LightingTemplate { get; set; } = ""; public string ImageSpace { get; set; } = ""; public string Music { get; set; } = ""; public CellLightingSpec? Lighting { get; set; } } // waterHeight: XCLW; water: ref → WATR (XCWT); acousticSpace: ref → ASPC (XCAS); lightingTemplate/imageSpace: in-spec editorId OR vanilla <master>:0xFORMID; music: ref → MUSC; lighting: inline XCLL overrides
