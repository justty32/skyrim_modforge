...
- [總覽 + 前置 + 規劃](custom-skill-tree-guide-overview-planning.md) — 需要哪些拼圖、前置需求、規劃技能樹
- [Step 2：esp 記錄](custom-skill-tree-guide-esp-records.md) — 在 esp 裡建記錄
- [Step 3–4：X.json + 選單](custom-skill-tree-guide-json-and-menu.md) — 逐欄寫 `<X>.json` + 掛進選單
- [Step 5：XP / 升級 / 訓練](custom-skill-tree-guide-xp-leveling.md) — XP/升級/訓練接線
- [Step 6–7：在地化 / 測試 / 生成 / Checklist](custom-skill-tree-guide-l10n-test-gen.md) — 在地化、煙霧測試、用 ModForge 生成、常見地雷
